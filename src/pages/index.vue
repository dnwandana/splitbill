...
<template>
  ...
  <div v-if="currentStep === 'landing'" class="editorial-page min-h-screen">
      ...
      <div class="container-editorial">
        <div class="flex justify-between items-center">
          <div class="flex items-center gap-3 animate-fade-in">
            <span class="font-serif text-2xl font-medium tracking-tight">SplitBill</span>
          </div>
          <div class="flex items-center gap-6">
            <select v-model="userCurrency" class="select-editorial w-28 md:w-40 animate-fade-in delay-1">
      ...
      <div class="container-editorial">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[70vh]">
          ...
          <div class="order-2 lg:order-1">
            ...
            <!-- Trust signals -->
            <div class="flex flex-wrap items-center gap-6 text-caption animate-fade-in-up delay-4">
          ...
          <div class="order-1 lg:order-2 flex justify-center lg:justify-end animate-slide-right delay-2">
            <div class="relative">
              <!-- Decorative elements -->
              <div class="absolute -top-4 -left-4 w-24 h-24 border border-[var(--color-border)] opacity-50" />
              <div class="absolute -bottom-4 -right-4 w-24 h-24 bg-[var(--color-accent)] opacity-10" />

              <!-- Receipt mockup -->
              <div class="receipt-mockup animate-float relative z-10">
                <div class="text-center mb-4 pb-3 border-b border-dashed border-gray-300">
                ...
                <div class="border-t border-dashed border-gray-300 pt-3 space-y-1 text-xs">
                  ...
                  <div class="flex justify-between font-bold text-sm pt-2 border-t border-gray-200">
                    <span>TOTAL</span>
                    <span class="font-mono">$90.72</span>
                  </div>
                </div>
                <div class="mt-4 pt-3 border-t border-dashed border-gray-300 text-center">
    ...
    <!-- Narrative Section -->
    <section class="py-24 md:py-32 bg-[var(--color-bg-card)] border-y border-[var(--color-border)]">
      <div class="container-editorial">
        <div class="max-w-3xl mx-auto">
          ...
          <p class="text-body text-[var(--color-text-secondary)] mb-8 reveal" style="transition-delay: 200ms">
          ...
          <div class="divider-editorial mb-8 reveal" style="transition-delay: 300ms" />
    ...
    <section class="py-24 md:py-32 bg-[var(--color-text-primary)]">
      <div class="container-editorial">
        <div class="text-center mb-16">
          ...
          <h2 class="text-headline text-white reveal" style="transition-delay: 100ms">
            Built for real-world dining
          </h2>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div class="card-editorial bg-white/5 border-white/10 hover:border-white/20 reveal"
            style="transition-delay: 200ms">
            <div class="w-10 h-10 flex items-center justify-center bg-[var(--color-accent)] text-white mb-6">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <footer class="py-8 border-t border-[var(--color-border)]">
      <div class="container-editorial">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div class="flex flex-wrap items-center justify-center gap-4 text-caption">
            <span class="text-[var(--color-border)]">|</span>
            <span>
              AI by
              <a href="https://openrouter.ai" target="_blank" class="link-underline">OpenRouter</a>
            </span>
            <span class="text-[var(--color-border)]">|</span>
            <span>
              Analytics by
              <a href="https://umami.is" target="_blank" class="link-underline">Umami</a>
            </span>
          </div>
        </div>
      </div>
  ...
  <div v-else-if="currentStep === 'upload'"
    ...
    <div class="w-full max-w-2xl">
      ...
      <!-- File Upload -->
      <div class="mb-8">
        <div class="upload-zone-editorial" :class="{
          ...
          <div class="flex flex-col items-center justify-center">
            <div class="w-16 h-16 mb-6 flex items-center justify-center">
              <svg class="w-full h-full" :class="file
            ...
            <div v-if="file" class="text-center">
              <p class="font-serif text-xl mb-2 text-[var(--color-text-primary)]">
                {{ file.name }}
              </p>
              <p class="text-caption mb-4">
                {{ formatFileSize(file.size) }}
              </p>
              <button class="btn-editorial btn-editorial-sm btn-editorial-danger" @click.stop="clearFile">
      ...
      <div class="flex justify-center">
        <button :disabled="!file" class="btn-editorial" :class="{ 'opacity-50 cursor-not-allowed': !file }"
          @click="startParsing">
  ...
  <!-- Participants Step -->
  <div v-else-if="currentStep === 'participants'" class="step-page-editorial flex flex-col items-center p-4 py-12">
    <div class="w-full max-w-2xl">
      <!-- Header -->
      <div class="step-header-editorial">
      ...
      <!-- Parsing Progress -->
      <div v-if="isParsingInBackground || parseProgress !== 'idle'" class="card-editorial mb-8">
        <div class="flex items-center gap-3 mb-4">
          <div class="w-8 h-8 flex items-center justify-center" :class="{
            'text-[var(--color-accent)]':
              parseProgress === 'uploading' || parseProgress === 'parsing',
            'text-green-600': parseProgress === 'complete',
            'text-red-600': parseProgress === 'error'
          }">
            <svg v-if="parseProgress === 'parsing'" class="w-5 h-5 animate-spin" fill="none" stroke="currentColor"
              viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
            </svg>
            <svg v-else-if="parseProgress === 'complete'" class="w-5 h-5" fill="none" stroke="currentColor"
              viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <svg v-else-if="parseProgress === 'error'" class="w-5 h-5" fill="none" stroke="currentColor"
              viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="progress-editorial">
          <div class="progress-editorial-bar" :class="{ animate: parseProgress === 'parsing' }" :style="{
            width:
              parseProgress === 'uploading'
                ? '30%'
                : parseProgress === 'parsing'
      ...
      <div class="card-editorial">
        <div class="flex justify-between items-center mb-6 pb-4 border-b border-[var(--color-border)]">
          ...
          <button class="btn-editorial btn-editorial-sm" @click="addParticipant">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-4">
          <div v-for="(participant, index) in participants" :key="index" class="flex items-center gap-3">
            <span class="avatar-editorial avatar-editorial-md" :style="{ backgroundColor: participantColor(index) }">
              {{ (participant?.trim() || `P${index + 1}`)[0]?.toUpperCase() }}
            </span>
            <input v-model="participants[index]" type="text" :placeholder="`Person ${index + 1}`"
      ...
      <div class="flex justify-center mt-8">
        <button class="btn-editorial" :disabled="parseProgress === 'error' ||
          parseProgress === 'uploading' ||
          parseProgress === 'parsing'
          " :class="{
  ...
  <!-- Review Receipt Step -->
  <div v-else-if="currentStep === 'review'" class="step-page-editorial flex flex-col items-center p-4 py-12">
    <div class="w-full max-w-4xl">
      <!-- Header -->
      <div class="step-header-editorial">
        <button class="back-link-editorial mb-6" @click="goToStep('participants')">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
          </svg>
          ...
          <div v-for="(item, index) in receipt?.items || []" :key="index"
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
              ...
              <div class="md:col-span-5">
                ...
                <input :value="item.name" type="text" placeholder="Item name" class="input-editorial" @input="
                  updateItemName(
                    index,
              ...
              <div class="md:col-span-2">
                ...
                <input :value="item.quantity" type="number" min="0.01" step="0.01" placeholder="Qty"
                  class="input-editorial input-editorial-mono" @input="
                    updateItemQuantity(
                      index,
              ...
              <div class="md:col-span-2">
                ...
                <input :value="item.price" type="number" min="0" step="0.01" placeholder="Price"
                  class="input-editorial input-editorial-mono" @input="
                    updateItemPrice(
                      index,
                      Number(($event.target as HTMLInputElement).value)
              ...
              <div class="md:col-span-2">
                ...
                <div class="font-mono font-medium text-[var(--color-text-primary)] py-2">
              ...
              <div class="md:col-span-1 flex items-end justify-end">
                <button v-if="(receipt?.items || []).length > 1"
                  class="btn-editorial-ghost text-[var(--color-text-secondary)] hover:text-red-600"
      ...
      <!-- Summary Card -->
      <div class="card-editorial">
        <h3 class="font-serif text-xl mb-6 pb-4 border-b border-[var(--color-border)]">
          Summary
        </h3>
        ...
        <div>
          ...
          <div class="summary-row summary-row-divider">
            ...
            <div class="w-32">
              <input :value="receipt?.tax || 0" type="number" min="0" step="0.01" placeholder="Tax"
                class="input-editorial input-editorial-mono text-right" @input="
          ...
          <div class="summary-row summary-row-total">
            <span class="font-medium text-[var(--color-text-primary)]">Total</span>
            <span class="font-mono font-bold text-2xl text-[var(--color-accent)]">
  ...
  <!-- Assign Items Step -->
  <div v-else-if="currentStep === 'assign'" class="step-page-editorial flex flex-col items-center p-4 py-12">
    <div class="w-full max-w-4xl">
      <!-- Header -->
      <div class="step-header-editorial">
      ...
      <div class="space-y-8">
        ...
        <div class="card-editorial">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            <div v-for="(participant, index) in participants.filter((p) =>
              p.trim()
            )" :key="index" class="card-editorial card-editorial-interactive p-4 text-center" :class="[
              selectedParticipantIndex === index
                ? 'card-editorial-selected'
                : ''
            ]" @click="selectParticipant(index)">
              <div class="flex flex-col items-center gap-2">
                <span class="avatar-editorial avatar-editorial-lg"
                ...
                <span class="font-mono text-xs font-semibold text-[var(--color-accent)]">
          ...
          <div v-if="selectedParticipantIndex === null"
          ...
          <div v-else class="mt-6 text-center py-3 bg-[rgba(199,91,57,0.05)] border border-[var(--color-accent)]">
        ...
        <div class="card-editorial">
          ...
          <div class="space-y-4">
            <div v-for="(item, itemIndex) in receipt?.items || []" :key="itemIndex"
              class="border p-4 transition-all duration-200" :class="[
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex-1">
                  ...
                  <div class="font-mono font-semibold text-lg mt-1 text-[var(--color-text-primary)]">
                    {{ formatCurrency(item.quantity * item.price) }}
                  </div>
                </div>
                ...
                <div class="flex flex-wrap gap-2">
                  <template v-for="(p, pIndex) in participants" :key="pIndex">
                    ...
                    "
                      ...
                      <span class="avatar-editorial avatar-editorial-sm"
                      ...
                      <span class="font-mono text-xs text-[var(--color-accent)] font-semibold">
                        x{{ (itemAssignments[itemIndex] || {})[pIndex] }}
                      </span>
                    </div>
                  </template>
                  <div v-if="!Object.keys(itemAssignments[itemIndex] || {}).length" class="text-caption px-3 py-1">
                    Not assigned yet
                  </div>
                </div>

                <!-- Selected participant controls -->
                <div v-if="selectedParticipantIndex !== null" class="border-t border-[var(--color-border)] pt-4">
                  <div v-if="
                  ...
                  " class="flex items-center justify-between flex-wrap gap-3">
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <button class="btn-editorial btn-editorial-sm btn-editorial-danger" @click.stop="
                  ...
                  <div v-else>
                    <button class="btn-editorial btn-editorial-sm w-full" @click="assignItemToSelected(itemIndex)">
                      <span>Assign to
                        {{
                          participants[selectedParticipantIndex]?.trim()
                        }}</span>
                ...
                <div v-else class="text-caption text-center py-2 border-t border-[var(--color-border-light)]">
        ...
        <div class="card-editorial mb-8">
          <div class="flex flex-wrap justify-center items-center gap-8">
            <div class="text-center">
              ...
              <p class="font-mono font-bold text-xl text-[var(--color-text-primary)]">
                {{
                  formatCurrency(
            ...
            <div class="text-center">
              ...
              <p class="font-mono font-bold text-2xl text-[var(--color-text-primary)]">
                {{ formatCurrency(receipt?.total || 0) }}
              </p>
            </div>
          </div>
  ...
  <!-- Results Step -->
  <div v-else-if="currentStep === 'results'" class="step-page-editorial flex flex-col items-center p-4 py-12">
    <div class="w-full max-w-4xl">
      <!-- Header -->
      <div class="step-header-editorial">
        <div class="w-16 h-16 mx-auto mb-6 flex items-center justify-center bg-green-100 text-green-600 rounded-full">
      ...
      <div class="card-editorial mb-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <p class="text-caption mb-1">Subtotal</p>
            <p class="font-mono text-xl font-bold text-[var(--color-text-primary)]">
          ...
          <div>
            ...
            <p class="text-xl font-bold" :class="Math.abs(
              ...
              {{
                Math.abs(
                  (splitResults?.originalTotal || 0) -
                  (splitResults?.splitTotal || 0)
                ) < 0.01 ? '✓ Perfect' : formatCurrency(Math.abs((splitResults?.originalTotal || 0) -
                  (splitResults?.splitTotal || 0))) + ' off' }} </p>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-6 mb-8">
        <div v-for="(participant, pIndex) in splitResults?.participants || []" :key="participant.name"
          class="card-editorial">
          <div class="flex justify-between items-center mb-6 pb-4 border-b border-[var(--color-border)]">
            <div class="flex items-center gap-3">
              <span class="avatar-editorial avatar-editorial-lg" :style="{ backgroundColor: participantColor(pIndex) }">
          ...
          <div>
            <!-- Items breakdown -->
            <div v-for="item in participant.items" :key="item.name"
            ...
            <!-- Tax breakdown -->
            <div v-if="participant.taxPortion > 0"
              class="flex justify-between items-center py-2 border-b border-[var(--color-border-light)]">
              <span class="text-sm text-[var(--color-accent)]">
                Tax (proportional share)
              </span>
              <span class="font-mono text-sm font-medium text-[var(--color-accent)]">
            ...
            <div class="pt-4 space-y-2">
              ...
              <div class="summary-row summary-row-total">
                ...
                <span class="font-mono font-bold text-xl text-[var(--color-accent)]">
                  {{ formatCurrency(participant.total) }}
                </span>
              </div>
            </div>
